...
class ContractTest extends TestCase
{
    ...
    public function testContractWithStruct()
    {
        ...
        $abi = '[
   {
      ...
      "type":"function"
        ...
        $contract->call('method', $params_array, function ($err, $res) {
            if ($err !== null) {
                echo 'Error when call method: ' . $err->getMessage() . "\n";
                return;
            }
            $this->assertEquals('0', $res[0]);
        });
